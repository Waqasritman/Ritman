...
import ritman.wallet.databinding.ReceiptLayoutMoneySendBinding;
...
import ritman.wallet.di.XMLdi.RequestHelper.GetTransactionReceiptRequest;
import ritman.wallet.di.XMLdi.apicaller.GetTransactionReceiptTask;
import ritman.wallet.dialogs.ShareDialog;
import ritman.wallet.interfaces.OnGetTransactionReceipt;
import ritman.wallet.interfaces.OnReceiptGenerator;
...
public class TransactionReceiptActivity extends RitmanBaseActivity<ReceiptLayoutMoneySendBinding>
    ...
    public void onGetTransactionReceipt(GetTransactionReceiptResponse receiptResponse) {
        ...
        binding.serviceFee.setText(NumberFormatter.decimal(receiptResponse.commissionCharge));
        binding.otherCharge.setText(
                NumberFormatter.decimal(
                        receiptResponse.otherCharges));
        binding.vat.setText(
                NumberFormatter.decimal(
                        receiptResponse.vatPercentage));
        binding.totalPayableAmount.setText(
                NumberFormatter.decimal(
                        receiptResponse.totalPayable));
        binding.exchangeRate.setText(
                NumberFormatter.decimal(
                        receiptResponse.exchangeRate));
...
//        }
        ...
        binding.customerIdType.setText(receiptResponse.id_Type);
        binding.customrExpireDate.setText(receiptResponse.senderIDExpiry);
