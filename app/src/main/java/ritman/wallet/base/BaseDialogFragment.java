...
public abstract class BaseDialogFragment<T extends ViewDataBinding> extends DialogFragment {
    ...
    protected T binding;
    private RitmanBaseActivity mActivity;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof RitmanBaseActivity) {
            RitmanBaseActivity activity = (RitmanBaseActivity) context;
    ...
    public RitmanBaseActivity getBaseActivity() {
        return mActivity;
    }
