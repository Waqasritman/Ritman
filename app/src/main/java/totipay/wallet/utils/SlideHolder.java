...
//	public final static int DIRECTION_RIGHT = -1;
    ...
    public final static int DIRECTION_RIGHT = -1;
    private final static int MODE_READY = 0;
    private final static int MODE_SLIDE = 1;
    ...
    private final Queue<Runnable> mWhenReady = new LinkedList<>();
    ...
    private class SlideAnimation extends Animation {
        ...
        SlideAnimation(float fromX, float toX, float speed) {
