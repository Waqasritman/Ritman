...
public class CameraSource {
    ...
    final Object mCameraLock = new Object();

    // Guarded by mCameraLock
    Camera mCamera;

    int mFacing = CAMERA_FACING_BACK;
    ...
    String mFocusMode = null;
    String mFlashMode = null;
    ...
    FrameProcessingRunnable mFrameProcessor;
     ...
     */
    final Map<byte[], ByteBuffer> mBytesToByteBuffer = new HashMap<>();
    ...
    interface AutoFocusCallback {
         ...
         * <p/>
         * The auto-focus routine does not lock auto-exposure and auto-groupe
    ...
    public static class CameraAutoFocusMoveCallback implements Camera.AutoFocusMoveCallback {
        AutoFocusMoveCallback mDelegate;
