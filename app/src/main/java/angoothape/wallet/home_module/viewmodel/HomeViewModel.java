package angoothape.wallet.home_module.viewmodel;
...
public class HomeViewModel extends ViewModel {
    ...
    public LiveData<NetworkResource<AEResponse>> getMerchantLedger(AERequest request, String key, String sKey) {
        MutableLiveData<NetworkResource<AEResponse>> data = new MutableLiveData<>(); // receiving
        Call<AEResponse> call = restApii.getMerchantLedger(RestClient.makeGSONRequestBody(request)
    ...
    public LiveData<NetworkResource<AEResponse>> uploadCashDetails(AERequest request, String key, String sKey) {
        MutableLiveData<NetworkResource<AEResponse>> data = new MutableLiveData<>(); // receiving
        Call<AEResponse> call = restApii.uploadCashDetails(RestClient.makeGSONRequestBody(request)
                , key, sKey); // rest api declaration
