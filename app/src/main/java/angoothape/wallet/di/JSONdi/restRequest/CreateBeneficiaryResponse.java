...
public class CreateBeneficiaryResponse extends ApiResponse<CreateBeneficiaryResponse> implements Parcelable {
    ...
    public CreateBeneficiaryResponse(Parcel in) {
    ...
    public static final Parcelable.Creator<GetBeneficiaryListResponse> CREATOR = new Parcelable.Creator<GetBeneficiaryListResponse>() {
        @Override
