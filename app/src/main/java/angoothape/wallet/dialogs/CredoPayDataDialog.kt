...
class CredoPayDataDialog(var methodType: String,
                         var titleName: String,
                         private val delegate: OnCredoPayApiDataSelect) : DialogFragment(), OnCredoPayApiDataSelect {

    lateinit var sessionManager: SessionManager
    lateinit var adapter: CredoPayApiDataAdapter
    ...
    fun recyclerView(data: List<GetApiData>) {
        ...
        adapter = CredoPayApiDataAdapter(data, data, this)
