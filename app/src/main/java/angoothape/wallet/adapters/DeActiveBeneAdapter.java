...
import angoothape.wallet.databinding.BeneDeActiveDesignBinding;
...
public class DeActiveBeneAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public DeActiveBeneAdapter(List<GetBeneficiaryListResponse> beneficiaryListResponses
            , OnSelectBeneficiary onSelectBeneficiary) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (ITEM == viewType) {
            BeneDeActiveDesignBinding binding =
                    BeneDeActiveDesignBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
