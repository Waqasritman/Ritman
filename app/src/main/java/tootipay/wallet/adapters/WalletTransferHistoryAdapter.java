...
import tootipay.wallet.databinding.TransactionHistoryDesignBinding;
...
public class WalletTransferHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof WalletTransferHistoryAdapterView) {
            ...
            ((WalletTransferHistoryAdapterView) holder).binding.dateTrans.setText(response.transactionDate);
